...
// FraudDetectionServiceV2 handles fraud detection and risk assessment for claims and applications.
// This is the refactored version that uses Customer domain model, dynamic configuration, and events.
type FraudDetectionServiceV2 struct {
...
// NewFraudDetectionServiceV2 creates a new FraudDetectionServiceV2 instance.
func NewFraudDetectionServiceV2(
	claimStore store.ClaimStore,
	policyStore store.PolicyStore,
	customerStore store.CustomerStore,
	configManager *config.ConfigManager,
	...
	return &FraudDetectionServiceV2{
...
func (s *FraudDetectionServiceV2) AnalyzeClaimForFraudV2(ctx context.Context, claimID uuid.UUID) (*FraudScoreV2, error) {
	// Get configuration
...
func (s *FraudDetectionServiceV2) analyzeClaimTimingV2(claim *models.Claim, policy *models.Policy, config *config.FraudDetectionConfig) FraudFactorV2 {
...
func (s *FraudDetectionServiceV2) analyzeClaimAmountV2(claim *models.Claim, policy *models.Policy, config *config.FraudDetectionConfig) FraudFactorV2 {
	factor := FraudFactorV2{
		Factor: "claim_amount",
...
func (s *FraudDetectionServiceV2) analyzeCustomerHistoryV2(claim *models.Claim, customer *models.Customer, config *config.FraudDetectionConfig) FraudFactorV2 {
	factor := FraudFactorV2{
...
func (s *FraudDetectionServiceV2) analyzeIncidentPatternsV2(claim *models.Claim, policy *models.Policy, config *config.FraudDetectionConfig) FraudFactorV2 {
	factor := FraudFactorV2{
...
func (s *FraudDetectionServiceV2) analyzeDocumentationV2(claim *models.Claim, config *config.FraudDetectionConfig) FraudFactorV2 {
	factor := FraudFactorV2{
...
func (s *FraudDetectionServiceV2) analyzeGeographicRiskV2(claim *models.Claim, customer *models.Customer, config *config.FraudDetectionConfig) FraudFactorV2 {
	factor := FraudFactorV2{
...
func (s *FraudDetectionServiceV2) analyzeBehavioralPatternsV2(claim *models.Claim, customer *models.Customer, config *config.FraudDetectionConfig) FraudFactorV2 {
	factor := FraudFactorV2{
...
func (s *FraudDetectionServiceV2) analyzePolicyHistoryV2(claim *models.Claim, policy *models.Policy, config *config.FraudDetectionConfig) FraudFactorV2 {
	factor := FraudFactorV2{
...
func (s *FraudDetectionServiceV2) calculateConfidenceV2(factors []FraudFactorV2, config *config.FraudDetectionConfig) float64 {
...
func (s *FraudDetectionServiceV2) determineRiskLevelV2(score float64, config *config.FraudDetectionConfig) string {
...
func (s *FraudDetectionServiceV2) requiresManualReviewV2(score float64, factors []FraudFactorV2, config *config.FraudDetectionConfig) bool {
...
func (s *FraudDetectionServiceV2) generateRecommendationsV2(score *FraudScoreV2, factors []FraudFactorV2, config *config.FraudDetectionConfig) []string {
...
func (s *FraudDetectionServiceV2) GetFraudScoreV2(ctx context.Context, claimID uuid.UUID) (*FraudScoreV2, error) {
...
func (s *FraudDetectionServiceV2) UpdateFraudScoreV2(ctx context.Context, claimID uuid.UUID, newScore *FraudScoreV2) error {
